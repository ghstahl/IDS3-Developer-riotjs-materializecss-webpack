...
<app>
    ...
    <script >
        ...
        self.developerbaseurl = opts.developerbaseurl;
        ...
        this.on('before-mount', function() {
            ...
            RiotControl.trigger('developer-api-baseurl',self.developerbaseurl);
        ...
        this.menuItems = [
            ...
            {name:'Developer',href:'#identityserver-developer-detail',view : 'identityserver-developer-detail'},
